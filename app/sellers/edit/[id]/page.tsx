...
const inputClass = [
  ...
  'text-[0.88rem] sm:text-[0.9rem] text-[#0D0D0D] placeholder:text-black/30',
...
function FormField({
  ...
  return (
    <div className="flex flex-col gap-1.5">
      <label className="text-[0.8rem] sm:text-[0.82rem] font-semibold text-[#0D0D0D]/70 flex items-center gap-1">
        {label}
        {required && <span className="text-[#E8622A]">*</span>}
      </label>
      {children}
      {hint && <p className="text-[0.7rem] sm:text-[0.72rem] text-black/35">{hint}</p>}
    </div>
  );
}
    ...
    <div className="min-h-screen bg-[#F5F0E8]">
      ...
      <div className="bg-[#0D0D0D] px-4 sm:px-5 md:px-8 py-3 flex items-center justify-between gap-3">
        <div className="flex items-center gap-2 sm:gap-3 min-w-0">
          ...
          <span className="text-[#F5F0E8]/20 text-sm hidden sm:inline">/</span>
          <span className="text-[#F5F0E8]/80 text-[0.78rem] sm:text-sm truncate max-w-[160px] sm:max-w-[220px]">
            Edit: {product.name}
          </span>
        </div>
      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-5 md:px-8 py-8 sm:py-10">
        ...
        <div className="mb-8 sm:mb-10">
          <h1
            ...
            style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(1.55rem, 7vw, 2.6rem)' }}
          >
            Edit listing
          </h1>
          <p className="text-[0.86rem] sm:text-[0.9rem] text-black/40">
            Changes go live immediately after saving.
          </p>
        </div>

        <div className="grid lg:grid-cols-[1fr_340px] gap-7 sm:gap-10 items-start">
          {/* ── Form ── */}
          <form onSubmit={handleSave} className="flex flex-col gap-5 sm:gap-6">
            {/* Current image */}
            <div className="bg-white rounded-[16px] sm:rounded-[20px] border border-black/[0.07] p-4 sm:p-5 flex gap-3 sm:gap-4 items-center">
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-[12px] sm:rounded-[14px] overflow-hidden flex-shrink-0 bg-[#EDE8DF]">
                <img
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-[0.84rem] sm:text-[0.88rem] text-[#0D0D0D] mb-1">Current image</p>
                <p className="text-[0.72rem] sm:text-[0.75rem] text-black/40 mb-3 truncate">{product.imagePlaceholder}.jpg</p>
                <label className="inline-flex items-center gap-2 text-[0.76rem] sm:text-[0.78rem] font-medium text-[#E8622A] cursor-pointer hover:opacity-70 transition-opacity">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-1 sm:pt-2">
              ...
              <Link
                href="/sellers/dashboard"
                className="h-[50px] sm:h-[52px] px-6 rounded-full border border-black/15 text-black/60 font-medium flex items-center justify-center hover:border-black/30 hover:text-black transition-all duration-200"
              >
                Cancel
              </Link>
            </div>
            ...
            {/* Danger zone */}
            <div className="border border-red-200 rounded-[14px] sm:rounded-[16px] p-4 sm:p-5 mt-1 sm:mt-2">
              <p className="font-semibold text-[0.84rem] sm:text-[0.88rem] text-red-600 mb-1">Danger zone</p>
              <p className="text-[0.78rem] sm:text-[0.8rem] text-black/45 mb-4">
          ...
          <div className="sticky top-[90px] flex flex-col gap-4">
            ...
            <div className="bg-white rounded-[16px] sm:rounded-[20px] border border-black/[0.07] p-4 sm:p-5">
              <p className="font-bold text-[0.9rem] sm:text-[0.95rem] text-[#0D0D0D] mb-4" style={{ fontFamily: 'var(--font-display)' }}>
                Listing performance
              </p>
              {[
                ...
                <div key={row.label} className="flex justify-between gap-3 py-2.5 border-b border-black/[0.05] last:border-0">
                  <span className="text-[0.78rem] sm:text-[0.8rem] text-black/45">{row.label}</span>
                  <span className="text-[0.78rem] sm:text-[0.8rem] font-semibold text-[#0D0D0D] capitalize text-right">
                    {row.value}
                  </span>
                </div>
              ))}
            ...
            <div className="bg-white rounded-[16px] sm:rounded-[20px] border border-black/[0.07] overflow-hidden">
              ...
              <div className="p-4">
                <p className="text-[0.66rem] sm:text-[0.68rem] text-[#E8622A] uppercase tracking-[0.07em] mb-1">Your Store</p>
                <p className="font-bold text-[0.9rem] sm:text-[0.95rem] text-[#0D0D0D]" style={{ fontFamily: 'var(--font-display)' }}>
                  {name}
                </p>
                <p className="font-extrabold text-[1rem] sm:text-[1.1rem] text-[#0D0D0D] mt-2" style={{ fontFamily: 'var(--font-display)' }}>

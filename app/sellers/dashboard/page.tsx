    ...
    <div className="relative rounded-[24px] overflow-hidden mb-8">
      ...
      <div
        ...
        style={{
          ...
          background: 'linear-gradient(100deg, rgba(13,13,13,0.92) 0%, rgba(13,13,13,0.6) 55%, rgba(232,98,42,0.2) 100%)',
        }}
      />
      ...
      <div className="relative z-10 px-8 py-8 md:py-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
        <div>
          {/* Seller badge */}
          <div className="inline-flex items-center gap-2 bg-[#E8622A]/20 border border-[#E8622A]/30 rounded-full px-3 py-1 mb-4">
            <span className="w-1.5 h-1.5 rounded-full bg-[#E8622A]" />
            <span className="text-[0.7rem] font-semibold text-[#E8622A] uppercase tracking-[0.1em]">
              Verified Seller
            </span>
          </div>
          ...
          <p className="text-[#F5F0E8]/55 text-[0.9rem]">
        ...
        <div className="flex flex-wrap gap-3">
          <Link
            href="/sellers/new"
            className="px-5 py-2.5 rounded-full bg-[#E8622A] text-white text-sm font-medium hover:-translate-y-[1px] hover:shadow-[0_6px_20px_rgba(232,98,42,0.4)] transition-all duration-200 flex items-center gap-2"
          >
          ...
          <Link
            href="/shopping"
            className="px-5 py-2.5 rounded-full border border-[#F5F0E8]/20 text-[#F5F0E8] text-sm font-medium hover:border-[#F5F0E8]/45 hover:bg-[#F5F0E8]/[0.06] transition-all duration-200"
          >
            View your store →
          </Link>
        </div>
    ...
    <div className="min-h-screen bg-[#F5F0E8]">
      ...
      <div className="bg-[#0D0D0D] px-5 md:px-8 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link href="/" className="inline-flex items-center gap-2">
            ...
            <span className="font-extrabold text-[1.1rem] text-[#F5F0E8] tracking-[-0.02em]"
              style={{ fontFamily: 'var(--font-display)' }}>
              K<span className="text-[#E8622A]">O</span>VA
            </span>
          </Link>
          <span className="text-[#F5F0E8]/20 text-sm">/</span>
          <span className="text-[#F5F0E8]/50 text-sm">Seller Dashboard</span>
        </div>
      ...
      <div className="max-w-[1280px] mx-auto px-5 md:px-8 py-8">
        ...
        <div className="grid lg:grid-cols-[1fr_340px] gap-6 mb-8">
          ...
          <div className="bg-[#0D0D0D] rounded-[20px] p-6 flex flex-col justify-between">
            <div>
              <span className="text-[0.68rem] font-semibold text-[#E8622A] uppercase tracking-[0.1em]">
                💡 Tip of the week
              </span>
              <h3
                className="font-bold text-[1.05rem] text-[#F5F0E8] mt-3 mb-2"
                style={{ fontFamily: 'var(--font-display)' }}
              >
                Add 3+ images to boost conversions
              </h3>
              <p className="text-[0.85rem] text-[#F5F0E8]/50 leading-relaxed">
                Listings with multiple images convert 62% better. Update your top products today.
              </p>
            </div>
            <Link
              href="/sellers/new"
              className="mt-6 inline-flex items-center gap-2 text-[0.82rem] font-medium text-[#E8622A] hover:opacity-70 transition-opacity"
            >
              Update listings →
            </Link>
          </div>
        ...
        <div className="grid lg:grid-cols-[1fr_1fr] gap-6 mb-8">
          ...
          <div className="bg-white rounded-[20px] border border-black/[0.07] p-6">
            <h2 className="font-bold text-[1rem] text-[#0D0D0D] mb-5" style={{ fontFamily: 'var(--font-display)' }}>
              Payout summary
            </h2>
            <div className="space-y-4">
              {[
                ...
                <div key={row.label} className={`flex justify-between items-center py-3 ${row.highlight ? 'bg-[#E8622A]/[0.06] px-4 rounded-[12px] -mx-4' : 'border-b border-black/[0.05]'}`}>
                  <span className="text-[0.85rem] text-black/55">{row.label}</span>
                  <span className={`font-bold text-[0.95rem] ${row.highlight ? 'text-[#E8622A]' : 'text-[#0D0D0D]'}`}>
                    {row.value}
                  </span>
                </div>
              ))}
            </div>
            <button className="w-full mt-6 py-3 rounded-full bg-[#0D0D0D] text-[#F5F0E8] text-sm font-medium hover:bg-[#E8622A] transition-all duration-200">
              Request payout
            </button>
          </div>
        </div>

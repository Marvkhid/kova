...
export default function NotFound() {
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0D0D0D]">
      ...
      {/* Content */}
      <div className="relative z-10 text-center px-6 max-w-[560px] mx-auto">

        {/* Logo */}
        <Link href="/" className="inline-flex items-center gap-2 mb-14 group">
          ...
          <span className="font-extrabold text-[1.3rem] tracking-[-0.03em] text-[#F5F0E8]"
        ...
        {/* 404 */}
        <p
          className="font-extrabold text-[#E8622A] mb-4 leading-none"
          style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(6rem, 20vw, 12rem)' }}
        >
          404
        </p>

        <h1
          className="font-extrabold text-[#F5F0E8] mb-4 leading-[1.05] tracking-[-0.02em]"
          style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(1.6rem, 4vw, 2.4rem)' }}
        >
          Lost in the marketplace.
        </h1>

        <p className="text-[#F5F0E8]/50 text-[1rem] leading-relaxed mb-10">

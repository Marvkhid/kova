      ...
      <div className="flex flex-col gap-1.5 w-full">
        ...
        <div className="relative">
          ...
          <input
            ref={ref}
            className={[
              'w-full h-[46px] sm:h-[48px] rounded-[12px]',
              'bg-[#F5F0E8] border',
...
export function AuthDivider({ label = 'or' }: { label?: string }) {
  return (
    <div className="flex items-center gap-3 w-full">
      ...
      <span className="text-[0.72rem] sm:text-[0.75rem] text-black/35 font-medium uppercase tracking-[0.08em]">
        {label}
      </span>
      <div className="flex-1 h-[1px] bg-black/[0.08]" />
    </div>
  ...
  return (
    <button
      ...
      className={[
        ...
        'text-[0.88rem] sm:text-[0.9rem] font-medium text-[#0D0D0D]',
...
export function AuthSubmitButton({
  ...
  return (
    <button
      ...
      className={[
        'w-full h-[46px] sm:h-[48px] rounded-[12px]',
        'bg-[#E8622A] text-white font-medium text-[0.92rem] sm:text-[0.95rem]',
